          ...
          <div className="bg-white border border-gray-200 rounded-[20px] md:rounded-[24px] p-5 sm:p-8 shadow-xl flex flex-col w-full text-gray-900">
            ...
            <form className="flex flex-col space-y-5">
              <div className="flex flex-col space-y-1.5 md:space-y-2">
                <label htmlFor="email" className="text-[13px] md:text-sm font-medium text-gray-700">Alamat Email</label>
                <input 
                  type="email" 
                  id="email" 
                  name="email" 
              ...
              <div className="flex flex-col space-y-1.5 md:space-y-2">
                <label htmlFor="password" className="text-[13px] md:text-sm font-medium text-gray-700">Kata Sandi</label>
